...
function Library:NewWindow(ConfigWindow)
	local ConfigWindow = self:MakeConfig({
		Title = "Ziram Hub - Blox Fruits", -- Đã đổi thành Ziram Hub - Blox Fruits
		Description = "By NguyenAnhKhoa ", -- Đã đổi thành By NguyenAnhKhoa 
	}, ConfigWindow or {})
	...
	Line.Name = "Line"
	Line.Parent = Top
	Line.BackgroundColor3 = Color3.fromRGB(255, 255, 255) -- Đã đổi thành màu trắng
	...
	UIStroke.Color = Color3.fromRGB(255, 255, 255) -- Đã đổi thành màu trắng
	...
	Line_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255) -- Đã đổi thành màu trắng
	...
	function Tab:T(t)
		...
		Choose_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255) -- Đã đổi thành màu trắng
		...
		function TabFunc:AddSection(RealNameSection)
			...
			UIGradient.Color = ColorSequence.new { ColorSequenceKeypoint.new(0.00, Color3.fromRGB(24, 24, 25)), ColorSequenceKeypoint.new(0.52, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(24, 24, 25)) } -- Đã đổi thành màu trắng
			...
			function SectionFunc:AddToggle(cftoggle)
				...
				function ToggleFunc:Set(Boolean)
					if Boolean then
						Library:TweenInstance(ToggleCheck, 0.3, "BackgroundColor3", Color3.fromRGB(255, 255, 255)) -- Đã đổi thành màu trắng
						Library:TweenInstance(Check, 0.3, "Position", UDim2.new(0, 22, 0.5, 0))
						Library:TweenInstance(Check, 0.3, "BackgroundColor3", Color3.fromRGB(60, 60, 60))
					else
			...
			function SectionFunc:AddDropdown(cfdropdown)
				...
				function DropFunc:Add(v)
					...
					UIGradient_3.Color = ColorSequence.new { ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.51, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) } -- Đã đổi thành màu trắng
			...
			function SectionFunc:AddSlider(cfslider)
				...
				SliderDraggable.BackgroundColor3 = Color3.fromRGB(255, 255, 255) -- Đã đổi thành màu trắng
				...
				Circle.BackgroundColor3 = Color3.fromRGB(60, 60, 60) -- Đã đổi màu để tương phản tốt hơn
				...
				SliderValue.BackgroundColor3 = Color3.fromRGB(255, 255, 255) -- Đã đổi thành màu trắng
				...
				SliderValue.Text = ""
				SliderValue.TextColor3 = Color3.fromRGB(0, 0, 0) -- Đổi text màu đen cho dễ đọc
	...
	-- Thay đổi toggle UI với code mới
	G2L["2"]["BackgroundColor3"] = Color3.fromRGB(40, 40, 40);
	G2L["2"]["Image"] = "";
	G2L["2"]["Size"] = UDim2.new(0, 50, 0, 50);
	G2L["2"]["BorderColor3"] = Color3.fromRGB(27, 42, 53);
	G2L["2"]["Position"] = UDim2.new(0.15, 0, 0.15, 0);
	G2L["2"]["Draggable"] = true;
	G2L["2"]["Name"] = "dut dit";
	G2L["2"]["AutoButtonColor"] = false;
	G2L["2"]["AnchorPoint"] = Vector2.new(0.1, 0.1);
	...
	ImageLabel["Image"] = "rbxassetid://123188942340057";
	...
	G2L["4"]["Color"] = Color3.fromRGB(255, 255, 255); -- Đã đổi thành màu trắng
